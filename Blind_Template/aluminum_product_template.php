            ...
            <div class = "product-div">
                ...
                <div class = "product-div-right">
                  <!-- 제품 1 이름 product 1 name -->
                    <span class = "product-name">Classic Light Filtering Aluminum Blinds</span>
                    ...
                    <form name="submit" id="submit" action="">
                      ...
                      <br>
                      <label for="menuOptions" style="display: none;">Headcover Options:</label>
                      ...
                      <div id="colorOptions" class="drop-down-container assistImageDiv"  style="display: none;"></div>
