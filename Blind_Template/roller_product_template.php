            ...
            <div class = "product-div">
                ...
                <div class = "product-div-right">
                  <!-- 제품 1 이름 product 1 name -->
                    <span class = "product-name">Classic Light Filtering Roller Blinds</span>
                    ...
                    <form name="submit" id="submit" action="">
                      <div class = "btn-groups ">
                        ...
                        <div class="dropdown">
                          ...
                          <select id="mountType" class="drop-down-btn" onchange="showMountImage()">
                          ...
                          <!-- Div for Inside Mount -->
                          <div id="insideMountImage" class="mount-image-description mount-assistImageDiv">
                            <img class="option-images" src="dist/images/inside_mount_image.jpg" alt="Inside Mount Image">
                            <p class="description">Description for Inside Mount Image</p>
                          </div>

                          <!-- Div for Outside Mount -->
                          <div id="outsideMountImage" class="mount-image-description mount-assistImageDiv">
                            <img class="option-images" src="dist/images/outside_mount_image.jpg" alt="Outside Mount Image">
                            <p class="description">Description for Outside Mount Image</p>
                          </div>
                        </div>
                        <!-- End Mount type -->
                        <br>
                        ...
                        <div id="cordPositionContainer" class="drop-down-container">
                          <!-- Div for left roll -->
                          <div id="leftImage" class="mount-image-description mount-assistImageDiv">
                            <img class="option-images" src="dist/images/left_image.jpg" alt="Left Roll Image">
                          <p class="description">Description for Left Roll Image</p>
                          </div>

                          <!-- Div for right roll -->
                          <div id="rightImage" class="mount-image-description mount-assistImageDiv">
                            <img class="option-images" src="dist/images/right_image.jpg" alt="Right Roll Image">
                            <p class="description">Description for Right Roll Image</p>
                          </div>
                        </div>
