            ...
            <div class = "product-div">
                ...
                <div class = "product-div-right">
                  <!-- 제품 1 이름 product 1 name -->
                    <span class = "product-name">Classic Light Filtering Roman Shades</span>
                    ...
                    <form name="submit" id="submit" action="">
                      <div class = "btn-groups ">
                        ...
                        <select id="controlOptionDropdown" class="drop-down-btn" onchange="updateDropdown()" placeholder="choose control option" required>
                          ...
                          <option value="option2" disabled>Cordless</option>
                      ...
                      <br>
                      <label for="menuOptions" style="display: none;">Headcover Options:</label><br>
                      <select id="menuOptions" class="drop-down-btn" onchange="handleMenuChange()" style="display: none;">
                        <option value="" disabled selected hidden>Input Measurements First</option>
                      </select> 

                      <!-- 헤드 색생 옵션 head cover colour-->
                      <div id="colorOptions" class="drop-down-container assistImageDiv"></div>
